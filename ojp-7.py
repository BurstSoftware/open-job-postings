...
def load_jobs():
    try:
        ...
        # Auto-generate UUID for empty IDs
...
AGENTS = {
    ...
    "📝 CV Tailor": {"emoji": "📄", "description": "Expert CV writer...", "system": "You are a world-class CV writer..."},
    "✉️ Cover Letter Writer": {"emoji": "💌", "description": "Creates personalized cover letters...", "system": "You write compelling..."},
    "🧠 Interview Coach": {"emoji": "🎤", "description": "Prepares you for interviews...", "system": "You are a STAR-method interview coach..."},
    "📈 Salary & Negotiation": {"emoji": "💰", "description": "Provides salary benchmarks...", "system": "You provide realistic salary benchmarks..."},
    "🚀 Upskill Advisor": {"emoji": "📚", "description": "Identifies skill gaps...", "system": "You analyze skill gaps..."}
}
...
with tab1:
    ...
    st.caption(f"📊 Loaded **{len(st.session_state.jobs)}** opportunities from CSV")
...
# ==================== TAB 2, 3, 4 (unchanged) ====================
# [Copy your original TAB 2, TAB 3, and TAB 4 code here - they remain the same]

with tab2:
    # ... your original AI Job Assistant code ...
    pass  # Replace with your full tab2 code

with tab3:
    # ... your original Profile code ...
    pass

with tab4:
    # ... your original NVIDIA Guide code ...
    pass
